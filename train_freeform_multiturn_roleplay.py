...
def preprocess(
    ...
    conversations = []
    for i, (source, system_prompt) in enumerate(zip(sources, system_prompts)):
        ...
        if system_prompt == "":
            ...
            conv_prompt = system_prompt +" "+ conv.get_prompt()
        #print("$$"+conv_prompt.strip()+"$$")
...
class SupervisedDataset(Dataset):
    ...
    def __init__(self, data_path: str, tokenizer: transformers.PreTrainedTokenizer):
        ...
        system_prompts = [example["system_prompt"] for example in list_data_dict]
        data_dict = preprocess(sources, tokenizer, system_prompts)
